...
| Service | Description |
|:---|:---|
| **🤖 AI Agent Development** | Autonomous pipelines using Google ADK, LangChain, and LLM frameworks |
...
| **👁️ Computer Vision** | Object detection, image segmentation, and CNN-based visual inspection |
